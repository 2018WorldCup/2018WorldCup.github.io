footdiv = {
    createFootDiv:function(divID){
		...
		var code = '<div class="row">'
			...
			+ '</div>'
			+ '<div class="col-sm-4 col-md-4 col-lg-4">'
			+ '    <div style="text-align:center;margin:0 auto;"><p style="font-size:16px;"><strong>contact us:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong></p>'
			...
			+ '</div>'
			+ '<div class="col-sm-4 col-md-4 col-lg-4">'
			+ '    <div style="text-align:left;margin:0 auto;"><p style="font-size:16px;"><strong>Contract address:</strong></p>'
